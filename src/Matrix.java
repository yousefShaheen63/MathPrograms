...
public class Matrix {
    ...
    public int oneMatricesOperations()
    {
    ...
    public int twoMatricesOperations()
    {
        System.out.println("Choose an operation : ");
    ...
    public void operation(Matrix matrix2) {
        ...
        if (matrix2 == null) {
            switch (oneMatricesOperations()) {
                case 1:
                    ...
                    printMatrix(scalarMultiplication(multiplication));
                    break;
                case 2:
                    System.out.println(transpose());
                    break;
                case 3:
                    System.out.println("The sum of the elements in the diagonal : "+ trace());
                    break;
                case 4:
                    System.out.println("Enter the power you'd like to apply on the matrix");
                    int power;
                    power = input.nextInt();
                    printMatrix(power(power));
                    break;
                default:
            ...
            switch (twoMatricesOperations()) {
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println(subtract(matrix2));
                    break;
                case 3:
                    System.out.println(multiplication(matrix2));
                    break;
                default:
                    System.out.println("Invalid option");
